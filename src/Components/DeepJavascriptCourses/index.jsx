...
const DeepHtmlCssCourses = () => {
    ...
    return (
        ...
        <h2 className="font-semibold font-">
            - Platzi - Deep Javascript -
        </h2>
        <ul className="mt-2 ml-2">
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Animaciones con CSS práctico - Practic animations with CSS');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('API REST con Javascript - API REST with Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('API REST con Javascript práctico - Practic API REST with Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('API REST con Javascript profesional - Professional API REST with Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Manipulación de arrays con Javascript - Arrays handling with Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Asincronismo con Javascript - Asyncronism with Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Básico de Javascript - Basics Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Complejidad algorítmica con Javascript -  Algorithmic complexity with Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Debugging con Chrome Devtools -  Debugging with Chrome Devtools');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Estructuras de datos con Javascript - Data structure with Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Clean code en Javascript - Javascript clean code');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Closures y scope en Javascript - Javascript closures and scope');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Javascript Engine (V8) y el Navigator - Javascript Engine (V8) and The Navigator');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('POO con Javascript básico - Basics OOP with Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('POO con Javascript intermedio - Intermediate OOP with Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Javascript práctico - Practic Javascript');
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Javascript: Matemáticas y estadística - Javascript: Math and estadistics');
                        context.setDiplomaImage('matematicas-estadistica-javascript.png');
                    }}>
            ...
            <li>
                <p className="cursor-pointer" onClick={() => {
                        context.openModalDiploma();
                        context.setDiplomaName('Programación orientada a objetos - Oriented Objects Programation');
